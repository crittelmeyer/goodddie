...
export const getDefaultThemeOverrides = (theme: Theme, prefersDarkMode = false, palette: Palette) =>
  createTheme(theme, {
    components: {
      MuiCssBaseline: {
    ...
    palette: palette || getDefaultPalette(prefersDarkMode ? 'light' : 'light') // TODO: add 'dark' here when dark mode is ready
  })
